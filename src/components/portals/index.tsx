    ...
    return (
        <div className="flex flex-col items-center justify-center">
            <div className="flex items-center justify-between w-full max-w-2xl mt-8">
                <h1 className="text-2xl">Trello Workspaces</h1>
                                    ...
                                    <div className="my-8 overflow-scroll shadow-sm">
                                        ...
                                        <table className="w-full text-sm border-collapse table-fixed">
                                            <thead>
                                                ...
                                                <th colSpan={1} className="p-4 pt-0 pb-3 pr-8 font-medium text-center border-b dark:border-slate-600 text-slate-400 dark:text-slate-200 w-[200px]">URL</th>
                                            ...
                                            <tbody className="bg-white dark:bg-slate-800">
                                                {
                                                    item.board.length && item.board.map((project: any, index: number) => (
                                                        <tr key={index}>
                                                            ...
                                                            <td className="p-4 pr-8 text-center border-b border-slate-100 dark:border-slate-700 text-slate-500 dark:text-slate-400">{project?.closed ?? 'N/A' }</td>
                                                            <td className="p-4 pr-8 text-center border-b border-slate-100 dark:border-slate-700 text-slate-500 dark:text-slate-400">{project?.memberships?.length ?? 'N/A' }</td>
                                                            ...
                                                            <td className="p-4 pr-8 text-center border-b border-slate-100 dark:border-slate-700 text-slate-500 dark:text-slate-400">{project?.url ?? 'N/A' }</td>
